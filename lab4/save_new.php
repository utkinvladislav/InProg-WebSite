...
$val = $_GET['val'];
$result = $mysqli->query("INSERT INTO Banks_Data SET name='$name',
inn='$inn', country='$country', rel_class='$rel_class', val='$val'");
if ($result){
    print "<p>Запись создана.";
    print "<p><a href='http://f0476784.xsph.ru/lab4/lab4.php'> Вернуться в обзорщик бд </a>";
}else{print "Ошибка сохранения. <a href='http://f0476784.xsph.ru/lab4/lab4.php'> Вернуться в обзорщик бд </a>";}
?>